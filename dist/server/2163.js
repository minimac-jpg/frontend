export const __rspack_esm_id = 2163;
export const __rspack_esm_ids = [2163];
export const __webpack_modules__ = {
7550(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
const columns = [
    ...
    {
        accessorKey: "spec.host",
        header: "Host",
        cell: (info)=>info.getValue() ?? "-"
    },
    {
        accessorKey: "spec.path",
        header: "Path",
        cell: (info)=>info.getValue() ?? "/"
    },
    {
        accessorKey: "spec.to.name",
        header: "Target Service"
    }
];
function WorkersRoutesRoute() {
    const { data, isLoading } = (0,_features_console_api_queries__rspack_import_1/* .useRoutes */.Ye)();
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsxs)("div", {
                children: [
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__rspack_import_0.jsx)("p", {
                        ...
                        children: "Manage inbound traffic routes"
                    })
                ]
            }),
