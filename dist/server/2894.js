export const __rspack_esm_id = 2894;
export const __rspack_esm_ids = [2894];
export const __webpack_modules__ = {
35629(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
/* import */ var _better_auth_core_db_adapter__rspack_import_0 = __webpack_require__(40307);
/* import */ var _better_auth_core_env__rspack_import_1 = __webpack_require__(80557);
...
const memoryAdapter = (db, config) => {
	...
	*/
	const buildAdapterFactory = (activeDb) => (0,_better_auth_core_db_adapter__rspack_import_0/* .createAdapterFactory */.I)({
		config: {
			adapterId: "memory",
		...
		adapter: ({ getFieldName, getDefaultFieldName, options, getModelName }) => {
			...
			function convertWhereClause(where, model, join, select) {
				const baseRecords = (() => {
					...
					if (!table) {
						_better_auth_core_env__rspack_import_1/* .logger.error */.vF.error(`[MemoryAdapter] Model ${model} not found in the DB`, Object.keys(activeDb));
				...
				for (const baseRecord of baseRecords) {
					...
					for (const [joinModel, joinAttr] of Object.entries(join)) {
						...
						if (!joinTable) {
							_better_auth_core_env__rspack_import_1/* .logger.error */.vF.error(`[MemoryAdapter] JoinOption model ${joinModelName} not found in the DB`, Object.keys(activeDb));
