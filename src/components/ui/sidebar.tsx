...
function SidebarProvider({
  ...
  const contextValue = React.useMemo<SidebarContextProps>(
    ...
    [state, open, setOpen, isMobile, openMobile, toggleSidebar, position],
  );
  ...
  return (
    <div
      className={cn(
        ...
        position === "relative" ? "md:flex" : "md:block",
      )}
      data-state={state}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        showOnHover &&
          "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 peer-data-active/menu-button:text-sidebar-active-foreground aria-expanded:opacity-100 md:opacity-0",
        className,
      )}
      {...props}
    />
